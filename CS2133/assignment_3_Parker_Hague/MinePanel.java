...
public class MinePanel extends JPanel{
    ...
    public MinePanel(MineFrame f){
        frame = f;
        setLayout(new GridLayout(MineModel.NUMBER_OF_SQUARES, MineModel.NUMBER_OF_SQUARES));

        for (int row = 1; row < MineModel.NUMBER_OF_SQUARES + 1; row++){
            for (int col = 1; col < MineModel.NUMBER_OF_SQUARES + 1; col++){
    ...
    public class MineButton extends JButton{
        ...
        public class MouseHandler extends MouseAdapter { 
            ...
            public void mouseClicked(MouseEvent e){
                ...
                System.out.println(frame.getModel().bombCount());
