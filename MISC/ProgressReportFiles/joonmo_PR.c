...
void *mainTheadFuncK(void *queryFromClient)
{
...
int serverMainThreadUnitTest()
{
    ...
    if (pthread_create(&mainThread, NULL, mainTheadFuncK, (void *)&queryFromClient) != 0) {	// thread1 create
    ...
    */
	...
	if (pid < 0) { /* error occurred */
        ...
        int loopGoing = 1;
            ...
            // printf("To exit Server, Press Control + c \n");
            printf("Server is Working for 2 sec. Client should wait\n");
            sleep(2);
