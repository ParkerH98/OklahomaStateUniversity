...
public class SaturnRings : MonoBehaviour
{
    ...
    public float innerRadius = 0.7f; //0.7 ensures the rings are ~bigger than the sphere, as that's 0.5f by default in Unity.
    ...
    void Start()
    {
        ...
        int halfway = (segments + 1) * 2; //the start of the second side of the rings (top/bottom)
        ...
        for(int i=0; i<segments+1; i++)
        {
            ...
            //using the +halfway as equivalent allows us to set both sides of rings at once here:
